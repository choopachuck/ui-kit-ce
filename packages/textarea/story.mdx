...
import RawTextareaUserResize from '!!raw-loader!@v-uik/textarea/examples/TextareaUserResize'
...
## Пользовательское изменение размеров

Если необходимо пользователю позволить изменять размер поля, то можно передать свойство `resize`

<Canvas withSource="none">
  <TextareaUserResize />
</Canvas>

<Source language="tsx" code={RawTextareaUserResize} />
