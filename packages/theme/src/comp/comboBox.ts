...
export const createComboBox = (theme: Theme, compatibilityMode?: boolean) => ({
  ...
  inputColorBackgroundSearchableHover: '#f2f2f2', // TODO: after implementing overlay add backgroundComponent
  ...
  //TODO: токены с префиксом input заменить на control
